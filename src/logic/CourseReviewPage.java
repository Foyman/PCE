...
public class CourseReviewPage
{
    ...
    public static List<JComponentWithLayout> createFrame(String department, String courseNum, ArrayList<StudentReview> reviews)
    {
    ...
    public static void createMain(JPanel main, String courseNum, ArrayList<StudentReview> reviews)
    {
    ...
    public static double averageCriteria(int criteria, ArrayList<StudentReview> reviews)
    {
        int i;
        double total = 0;
    ...
    private static String calculateOverallGrade(ArrayList<StudentReview> reviews)
    {
        int total = 0;
