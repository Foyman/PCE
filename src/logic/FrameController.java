...
public class FrameController 
{
	...
	/** 
	 * Removes all the current JComponents from the frame and
	 * adds the previous JComponents from the components stack
	 * 
	 */
	...
	/**
	 * Removes all the current JComponents from the frame and
	 * adds the new JComponents from the List newComps.
	 * 
